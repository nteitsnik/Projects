...
mm=str(model)
with open(os.path.join(folder_path,r'Results\model_architecture.txt'), "w") as f:
    f.write(mm)   
...
with open(os.path.join(folder_path,r'Results\svm_params.txt'), "w") as f:
...
with open(os.path.join(folder_path,r'Results\xgb_best_params.txt'), "w") as f:
...
with open(os.path.join(folder_path,r'Results\ada.json'), "w") as f:
