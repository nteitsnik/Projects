...
df_train = pd.read_csv( r'C:\Users\Nteit\DS_Test-main\DS_Test-main\IDS\Data\UNSW_NB15_training-set.csv\UNSW_NB15_training-set.csv',index_col=False )
...
X_train, X_valid, y_train, y_valid = train_test_split(df_encoded_train_scaled, y_train_labels,stratify=y_train_labels, test_size=0.2, random_state=42)
...
df_test = pd.read_csv(
    r'C:\Users\Nteit\DS_Test-main\DS_Test-main\IDS\Data\UNSW_NB15_testing-set.csv\UNSW_NB15_testing-set.csv',
    index_col=False
)
...
with open(r'C:\Users\Nteit\DS_Test-main\DS_Test-main\IDS\Results\FNN_test_acc.json', "w") as f:
    json.dump(test_accuracy , f, indent=4)


mm=str(model)
with open(r"C:\Users\Nteit\DS_Test-main\DS_Test-main\IDS\Results\model_architecture.txt", "w") as f:
    f.write(mm)   
...
with open(r'C:\Users\Nteit\DS_Test-main\DS_Test-main\IDS\Results\svm_test_acc.json', "w") as f:
    json.dump(svm_acc , f, indent=4)

with open(r'C:\Users\Nteit\DS_Test-main\DS_Test-main\IDS\Results\svm_params.json', "w") as f:
...
with open(r'C:\Users\Nteit\DS_Test-main\DS_Test-main\IDS\Results\xgb_best_params.json', "w") as f:
    json.dump(grid_search.best_params_, f, indent=4)



with open(r'C:\Users\Nteit\DS_Test-main\DS_Test-main\IDS\Results\xgb_test_acc.json', "w") as f:
