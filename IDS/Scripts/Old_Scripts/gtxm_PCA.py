...
with open(os.path.join(folder_path,r'Results\ada_PCA.json'), "w") as f:   
    json.dump(accuracy_score(y_test_df, y_pred_ada),f, indent=4)
...
with open(os.path.join(folder_path,r'Results\xgb_gs_pca.json'), "w") as f:
...
with open(os.path.join(folder_path,r'Results\Stacked_model_pca_acc.json'), "w") as f:
    json.dump(accuracy_score(y_test_final, y_pred) , f, indent=4)
