...
df_test = pd.read_csv(
    r'C:\Users\aiane\git_repos\DS_Test\IDS\Data\UNSW_NB15_testing-set.csv\UNSW_NB15_testing-set.csv',
    index_col=False
)
...
with open(r'C:\Users\aiane\git_repos\DS_Test\IDS\Results\FNN_PCA.json', "w") as f:
    json.dump(test_accuracy,f , indent=4)


mm=str(model)
with open(r'C:\Users\aiane\git_repos\DS_Test\IDS\Results\model_architecture_PCA.txt', "w") as f:
    f.write(mm)   
...
with open(r'C:\Users\aiane\git_repos\DS_Test\IDS\Results\svm_PCA.json', "w") as f:
    json.dump(svm_acc , f, indent=4)

with open(r'C:\Users\aiane\git_repos\DS_Test\IDS\Results\svm_params_PCA.txt', "w") as f:
...
with open(r'C:\Users\aiane\git_repos\DS_Test\IDS\Results\xgb_best_params_PCA.txt', "w") as f:
    f.write(json.dumps(grid_search.best_params_, indent=4))



with open(r'C:\Users\aiane\git_repos\DS_Test\IDS\Results\xgb_PCA.json', "w") as f:
...
with open(r'C:\Users\aiane\git_repos\DS_Test\IDS\Results\ada_PCA.json', "w") as f:
